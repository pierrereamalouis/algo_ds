const validAnagram = require('./algo/anagram');
const sumZero = require('./algo/sumZero');
...
const searchString = require('./algo/searchString');

// validAnagram('cat', 'atc');

// sumZero([-4,-2,-1,1,2,7]);

// unique([1,2,3,4,4,7,8,9,9,10]);
...
console.log(searchString('lorie loed', 'lol'));
